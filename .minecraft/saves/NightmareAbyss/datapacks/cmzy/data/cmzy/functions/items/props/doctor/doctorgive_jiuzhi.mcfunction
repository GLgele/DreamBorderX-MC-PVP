...
execute if entity @a[tag=normal,tag=!ShangKou,limit=1,sort=nearest,distance=0.1..1.5] run function cmzy:items/props/doctor/doctorvalue1_jiuzhi
...
#给予治疗成功
execute as @a[scores={cmzy_doctortime=3970..}] at @a[tag=normal,tag=!ShangKou,limit=1,sort=nearest,distance=0.1..1.5] run scoreboard players set @s cmzy_doctorOF 3
